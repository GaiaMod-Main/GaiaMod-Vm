...
class Scratch3LearningMLBlocksTexts {
    ...
    getInfo() {
        return {
            ...
            blocks: [
                ...
                //         description: 'Add a text to a label or class'
                //     }),
                //     arguments: {
                //         ENTRY: {
                //             type: ArgumentType.STRING,
    ...
    classifyText(args) {
        ...
        if (modelType != 'text') {
            return 'NO TEXT MODEL';
        }

        return lmlMessageProtocol.lmlRequest("classify_text", [Cast.toString(args.TEXT)]);
    }
    ...
    confidenceText(args) {
        ...
        return lmlMessageProtocol.lmlRequest("confidence_text", [Cast.toString(args.TEXT)]);
    }
    ...
    //     lmlMessageProtocol.lmlRequest("add_text_to_label", [Cast.toString(args.ENTRY), Cast.toString(args.LABEL)]);
    // }

    // learnFromTextAndWait(args) {
    //     let modelType = localStorage.getItem("modelType");
    //     if (modelType != 'text') {
    //         return 'NO TEXT MODEL';
    //     }
